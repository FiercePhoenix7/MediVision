...
class App:
    def __init__(self) -> None:
        ...
        # 4. Generate embeddings (vectors) for all labels and the query text
        # This is fast and can be done once for all 150 labels and stored.
...
def listen():
    while True:
        ...
        try:
            ...
            voice_over("Sorry, Could you please repeat that?")
        except sr.RequestError as e:
            print(f"Could not request results from the speech recognition service; {e}")

print('-------------------------------------------')
print("AI: Say 'recognize' for recognizing a medicine, say 'detail' for knowing more about a medicine and say 'exit' to exit conversation.")
voice_over("Say 'recognize' for recognizing a medicine, say 'detail' for knowing more about a medicine and say 'exit' to exit conversation.")

user_input = listen()
print(f"User : {user_input}")

while user_input != 'exit':
    if user_input == 'recognise':
        ...
        print("AI : What medicine details are you looking for?")
        voice_over("What medicine details are you looking for")
        prompt = listen()
        print(f"User : {prompt}")
